...
eval("var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--5-1!../../../node_modules/postcss-loader/src!./index.css */ \"./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js!./src/aboutUs/assets/index.css\");\n\nif (typeof content === 'string') {\n  content = [[module.i, content, '']];\n}\n\nvar options = {}\n\noptions.insert = \"head\";\noptions.singleton = false;\n\nvar update = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ \"./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js\")(content, options);\n\nif (content.locals) {\n  module.exports = content.locals;\n}\n\nif (true) {\n  if (!content.locals) {\n    module.hot.accept(\n      /*! !../../../node_modules/css-loader/dist/cjs.js??ref--5-1!../../../node_modules/postcss-loader/src!./index.css */ \"./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js!./src/aboutUs/assets/index.css\",\n      function () {\n        var newContent = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--5-1!../../../node_modules/postcss-loader/src!./index.css */ \"./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js!./src/aboutUs/assets/index.css\");\n\n        if (typeof newContent === 'string') {\n          newContent = [[module.i, newContent, '']];\n        }\n        \n        update(newContent);\n      }\n    )\n  }\n\n  module.hot.dispose(function() { \n    update();\n  });\n}\n\n//# sourceURL=webpack:///./src/aboutUs/assets/index.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _routes_routes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./routes/routes */ \"./src/router/routes/routes.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar Router =\n/*#__PURE__*/\nfunction () {\n  function Router() {\n    _classCallCheck(this, Router);\n  }\n\n  _createClass(Router, [{\n    key: \"start\",\n    value: function start() {\n      window.addEventListener('popstate', this.back); // 本地文件\n      // if (/file/.test(location.href)) this.load('/')\n      // else this.load(location.pathname)\n    } // erp\n\n  }, {\n    key: \"go\",\n    value: function go(path, params) {\n      if (path === '/erp') path += \"\".concat(params ? '?product=' + params : '');else if (params) path += \"?title=\".concat(params);\n\n      try {\n        history.pushState({}, '', path);\n        this.load(path, params);\n      } catch (error) {\n        // console.error()\n        // 在本地打开项目文件\n        this.load(path, params);\n      }\n    } // 打开本地文件时如何载入\n\n  }, {\n    key: \"load\",\n    value: function load(path) {\n      console.log(path); // if (path === '/') {\n\n      if (/\\/$/.test(path)) {\n        var view = new (Object(_routes_routes__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('/home'))();\n        view.mount(document.getElementById('site-page-content'));\n      } // else if (/title/.test(path)) path = '/about/news'\n      // console.log(path.replace(/\\?.*$/, ''))\n      // const view = new routes[path.replace(/\\?.*$/, '')]()\n      else Object(_routes_routes__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(path.replace(/\\?.*$/, '')).then(function (module) {\n          var view = new module[\"default\"]();\n          view.mount(document.getElementById('site-page-content'));\n        });\n    }\n  }, {\n    key: \"back\",\n    value: function back() {\n      // 根据location.pathname\n      window.location.reload();\n      window.removeEventListener('popstate', this.back);\n    }\n  }, {\n    key: \"skip\",\n    value: function skip(path, param) {\n      // #path?title\n      // #path\n      try {\n        history.pushState({}, '', \"#\".concat(path).concat(param ? '?' + param : ''));\n        Object(_routes_routes__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(path).then(function (module) {\n          var view = new module[\"default\"]();\n          view.mount(document.getElementById('site-page-content'));\n        });\n      } catch (error) {\n        Object(_routes_routes__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(path).then(function (module) {\n          var view = new module[\"default\"]();\n          view.mount(document.getElementById('site-page-content'));\n        });\n      }\n    }\n  }]);\n\n  return Router;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (new Router());\n\n//# sourceURL=webpack:///./src/router/index.js?");
